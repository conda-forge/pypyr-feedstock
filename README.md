...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypyr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14936&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypyr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypyr` can be installed with:

```
conda install pypyr
```

It is possible to list all of the versions of `pypyr` available on your platform with:
